...
if l == 3:  #Condicional Verificando se foi digitado 3 lados
    ...
    print("A figura é um pentagono")  #Imprindo o valor da area do quadrado
    print(a)
elif l < 3:#Condicional Verificando se foi digitado menos que 3 lados
  print("A figura não é um poligono")
